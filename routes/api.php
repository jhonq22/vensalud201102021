...
Route::get('inventario/reportes/estadal/{estado_id}/{fecha1}/{fecha2}/{fecha3}/{fecha4}', 'InventarioController@ReporteInventarioEstadal');


Route::get('inventario/reportes/municipal/{municipio_id}/{fecha1}/{fecha2}/{fecha3}/{fecha4}', 'InventarioController@ReporteInventarioMunicipal');


Route::get('inventario/reportes/centro_salud/{centro_salud_id}/{fecha1}/{fecha2}/{fecha3}/{fecha4}', 'InventarioController@ReporteInventarioCentroSalud');
